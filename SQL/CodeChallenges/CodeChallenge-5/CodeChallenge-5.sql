create database CodeChallenge_5
...
--QUERY 1
--fetch details of books written by authors whose name ends with er
select * from books where author like '%er';

--display title, author, and reviewer name for all books
select b.title, b.author, r.reviewer_name from books b
left join reviews r
on b.id = r.book_id;

--QUERY 2
-- reviewer who reviewed more than one book
...
--QUERY 4
--display the date and total number of customers who placed orders on the same date
...
--QUERY 5
--display employee names in lowercase where salary is null
...
--display gender and total count
